...
import { updateProfiledAPI } from "../../Services/users/userServices";
import { data } from "react-router-dom";
import AlertMessage from "../Alert/AlertMessage";

const UserProfile = () => {
   // Mutation 
   const {mutateAsync, isError,isPending,isPaused,error,isSuccess} = useMutation({
    mutationFn: updateProfiledAPI,
    ...
    <>
      <div className="max-w-4xl mx-auto my-10 p-8 bg-white rounded-lg shadow-md">
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-4">
          ...
          {isSuccess && <AlertMessage type="success" message='Profile update successful'/>}
